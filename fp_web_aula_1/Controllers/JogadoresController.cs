...
namespace fp_web_aula_1.Controllers
{
    public class JogadoresController : Controller
    {
        ...
        public JogadoresController(CopaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("JogadorId,Nome,Posicao")] Jogador jogador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JogadorId,Nome,Posicao")] Jogador jogador)
        {
